...
const NavBar = () => {
    ...
    const routes = <>
        ...
        <li onClick={() => window.scrollTo({
            top: 0,
            behavior: "smooth",
        })}><NavLink to='/jobs' onClick={closeMenu} className={({ isActive }) => isActive ? 'text-green-500 border-b-2 border-green-500 rounded-md p-2' : 'hover:text-green-500 p-2'}>Jobs</NavLink></li>
